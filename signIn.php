...
<?php if (isset($_SESSION['username']) && !empty($_SESSION['username'])) { ?>
    <div class="logedIn">
        ...
        <form action="/pageview/updatePrice.php" method="post">
        ...
        <button onclick="location.href='/functions/logout.php'">LOG OUT</button>
    </div>
<?php } else { ?>

    <form class="loginForm" action="/functions/verify.php" method="post" autocomplete="off">
