<div>
    <div class="extras">
        ...
        <label class="container">Kajak $5
            <input type="checkbox" id="kajak" name="extras" name="kayak" value=5>
            <span class="checkmark"></span>
        </label>

        <label class="container">Kajak med fiskeutrustning $6
            <input type="checkbox" id="fiskeutrustning" name="extras" name="fishing gear" value=6>
            <span class="checkmark"></span>
        </label>

        <label class="checkbox">Bergsklättring $10
            <input type="checkbox" id="bergsklättring" name="extras" name="mountain clombing" value=10>
            <span class="checkmark"></span>
        </label>

        <label class="checkbox">Guidad tur över ön $8
            <input type="checkbox" id="guide" name="extras" name="gude" value=8>
            <span class="checkmark"></span>
        </label>
