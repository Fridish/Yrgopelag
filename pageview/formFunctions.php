<div>
    <div class="extras">
        ...
        <label class="container">Kajak med fiskeutrustning $6
            <input type="checkbox" id="fiskeutrustning" name="extras[fishing_gear]" value=6>
            <span class="checkmark"></span>
        </label>

        <label class="checkbox">Bergsklättring $10
            <input type="checkbox" id="bergsklättring" name="extras[mountain_climbing]" value=10>
            <span class="checkmark"></span>
        </label>

        <label class="checkbox">Guidad tur över ön $8
            <input type="checkbox" id="guide" name="extras[guide]" value=8>
            <span class="checkmark"></span>
        </label>
